 <!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>
       <span class="label label-primary"> Laporan Penjualan </span> 
      </h1>
    ...
    <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                <thead>
                <tr>
                  <th colspan="6">Tanggal & Waktu Transaksi Penjualan Barang</th>
                </tr>
                </thead>
                <tbody>
              <?php
              $transaksi=$mysqli->query("select distinct tanggal_transaksi from db_transaksi where jenis_transaksi=1");
